...
INSERT INTO `django_flatpage_sites` VALUES (32,1,1),(40,2,1),(26,3,1),(28,4,1),(34,5,1),(14,6,1),(35,7,1);
...
INSERT INTO `django_site` VALUES (1,'www.iam.dvo.ru','ИПМ ДВО РАН');
...
INSERT INTO `news_news` VALUES (1,'Новый сайт института','Запущена тестовая версия нового сайта, присутствует ссылка на предыдущую версию.','2010-07-08 14:28:38',13),(12,'Работа над дизайном','<p>Проводится активная работа над дизайном. В настоящий момент используется тестовый макет.</p>','2010-08-11 13:33:26',13),(15,'Работы над сервисами локальной сети ','<p>Завершился \"перенос\" сайта с неустойчивого оборудования.</p>\r\n<p>23.08.2010 г. планируется \"перенос\" почтового сервера, возможно кратковременное отключение сервиса. Завершение данного этапа позволит использовать централизованный спам - фильтр.&nbsp;</p>','2010-08-19 13:29:37',13),(16,'Изменения почтового сервиса','<p>01.09.2010 закончен&nbsp;перенос \"почты\" с неустойчивого оборудования при сохранении всей корреспонденции. Так же проведено обновление версии почтового сервера и установлен анти-спам фильтр. Корреспонденция, определенная как спам по результатам работы данного фильтра хранится в течение 2 месяцев, и может в случае крайней необходимости быть проверена. По истечению 2 месяцев&nbsp;данная корреспонденция&nbsp;удаляется.&nbsp;Письма маркированный как возможный спам&nbsp;направляются в почтовые&nbsp;ящики, где далее могут&nbsp;быть обработаны локальными правилами.</p>','2010-09-06 16:50:40',13),(17,'Сбой работы сети','<p>06.09.2010 произошел сбой&nbsp;одного из серверов&nbsp;по причине поломки, что повлияло на ограничение доступа в интернет до 12:00. Была проведена перенастройка на другое серверное оборудование. Сервис полностью восстановлен, проведено дублирования системы.</p>','2010-09-06 16:57:08',13),(18,'Корректировка информации на сайте','<p>В период тестовой эксплуатации при выявлении каких-либо неточностей в информации на сайте&nbsp;просьба сообщить по адресу <a href=\"mailto:root@iam.dvo.ru\">root@iam.dvo.ru</a> или в к. 313.</p>','2010-09-16 12:13:03',13);
...
INSERT INTO `users_profile` VALUES (1,2,1,'Александрович','д.ф.-м.н.','член-корр. РАН','','img/uploads/photo/2_2.jpg','<p><strong>Михаил Александрович Гузев</strong>, член корр РАН, директор и заведующий лабораторей конструктивных методов математики ИПМ ДВО РАН.</p>\r\n<p>специалист по математическому моделированию упруго-пластического поведения материалов с дефектами структуры и процессов распространения акустических волн в случайно-неоднородных средах.</p>\r\n<p>М.А. Гузев , 1962 г. рождения, окончил с отличием физический факультет Ленинградского государственного университета в 1984 г. и был зачислен в аспирантуру Научно-исследовательского института физики того же университета. По окончании аспирантуры в 1987 г. защитил диссертацию \"Адиабатический формализм и квазиклассика для дискретных уровней\" на степень кандидата физико-математических наук.</p>\r\n<p>Научную деятельность М.А. Гузев продолжил в Тихоокеанском океанологическом институте Дальневосточного отделения АН СССР, г. Владивосток, работая младшим научным, затем научным сотрудником лаборатории статистической гидрофизики с 1987 г. по 1991 г.. В 1991 г. избран по конкурсу на должность старшего научного сотрудника лаборатории геоинформатики Института автоматики и процессов управления с вычислительным центром ДВО АН СССР (современное наименование - Институт автоматики и процессов управления ДВО РАН). С 1998 г. по 2003 г. работал в лаборатории механики деформируемого твердого тела этого же института.</p>\r\n<p>В 1999 г. защитил докторскую диссертацию на тему \"Неевклидовы модели упруго-пластических материалов с дефектами структуры\" (физико-математические науки). В 2003 г. избран членом-корреспондентом Российской академии наук.</p>\r\n<p>С 2003 г. по 2005 г. М.А. Гузев был заместителем директора по научной работе Института автоматики и процессов управления ДВО РАН. В 2005 г. переходит в Президиум ДВО РАН, в котором работает до 2008 г. на должности главного ученого секретаря. В апреле 2008 г. избран директором Института прикладной математики ДВО РАН.</p>\r\n<p>М.А. Гузев уделяет большое внимание обучению студентов и подготовке научных кадров: директор Института математики и компьютерных наук Дальневосточного государственного университета, профессор этого университета, председатель диссертационного совета.</p>\r\n<p>Научные результаты - предложена дифференциальная формулировка описания евклидовых свойств математической модели классической теории упругости и показано, что она содержит \"скрытые\" параметры, допускающие естественную интерпретацию в качестве геометрических объектов аффинно-метрических пространств. Для материалов с дефектами структуры построен новый класс геометрически замкнутых неевклидовых моделей упруго-пластических материалов на основе предположения об аффинно-метрической структуре внутренних взаимодействий между частицами среды. Предложены методы расчета вычисления статистических пространственно-временных характеристик акустических волн для различных условий их распространения во флуктуирующих слабо диссипативных средах.</p>'),(3,7,2,'Николаевич','','','','',''),(4,8,3,'Евгеньевич','','','','',''),(5,9,4,'Юрьевич','','','','',''),(6,10,5,'Валентинович','','','','',''),(7,11,6,'Васильевич','','','','',''),(8,12,7,'Тимофеевич','','','','',''),(9,13,8,'Шалвович','','','','',''),(10,14,9,'Данилович','','','','',''),(11,15,1,'Алексеевич','','','','',''),(12,16,1,'Владимирович','','','','',''),(13,17,10,'Алексеевич','','','','','<P>&nbsp;</P>'),(14,1,11,'  ','','','','img/uploads/photo/1.jpg',''),(51,54,11,'Андревич ','к.ф.-м.н.','','Ученый секретарь','',''),(15,18,7,'В.','','','','',''),(16,19,7,'Николаевич','','','','',''),(17,20,7,'Викторович','','','','',''),(18,21,4,'Владимировна','','','','',''),(19,22,4,'В.','','','','',''),(20,23,4,'А.','','','','',''),(21,24,4,'А.','','','','',''),(22,25,2,'Борисович','','','','',''),(23,26,2,'Гумаровна','','','','',''),(24,27,2,'Иванович','','','','',''),(25,28,2,'Вячеславовна','','','','',''),(26,29,8,'Михайлович','','','','',''),(27,30,8,'Николаевич','','','','',''),(28,31,8,'Анатольевна','','','','',''),(29,32,8,'Иннокентьевич','','','','',''),(30,33,8,'Вадимовна','','','','',''),(31,34,5,'Анатольевич','','','','',''),(32,35,5,'Викторович','','','','',''),(33,36,5,'Владимировна','','','','',''),(34,37,5,'Сергеевич','','','','',''),(35,38,5,'Анатольевна','','','','',''),(36,39,5,'Александровна','','','','',''),(37,40,6,'Егорович','','','','',''),(38,41,6,'Геннадьевич','','','','',''),(39,42,6,'Петрович','','','','',''),(40,43,9,'А.','','','','',''),(41,44,9,'Геннадьевич','','','','',''),(42,45,9,'Н.','','','','',''),(43,46,3,'Николаевич','','','','',''),(44,47,3,'Г.','','','','',''),(45,48,1,'Васильевич','','','','',''),(46,49,1,'Алексеевич','','','','',''),(47,50,1,'Евгеньевич','','','','',''),(48,51,1,'Владимировна','','','','',''),(49,52,10,'Игоревич','','','лаборант','',''),(50,53,11,'Валентинович','','','Зам.директора по общим вопросам','','');
...
-- Dump completed on 2010-09-27 13:35:58
