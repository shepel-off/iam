...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.is_a_cool_guy'
        db.add_column('users_profile', 'is_a_cool_guy', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.is_a_cool_guy'
        db.delete_column('users_profile', 'is_a_cool_guy')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_a_cool_guy': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
