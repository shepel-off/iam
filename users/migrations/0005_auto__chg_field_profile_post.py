...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.post'
        db.alter_column('users_profile', 'post', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.post'
        db.alter_column('users_profile', 'post', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'users.profile': {
            ...
            'post': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
