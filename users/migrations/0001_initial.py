...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile', (
            ...
            ('laboratory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labs.Laboratory'])),
            ('mid_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('academic_degree', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('academic_rank', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('post', self.gf('django.db.models.fields.CharField')(max_length=100)),
