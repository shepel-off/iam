...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('labs_labgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('labs', ['LabGroup'])

        # Adding model 'Laboratory'
        db.create_table('labs_laboratory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labs.LabGroup'], blank=True)),
            ('head', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('about', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('labs', ['Laboratory'])


    def backwards(self, orm):
        
        # Deleting model 'LabGroup'
        db.delete_table('labs_labgroup')

        # Deleting model 'Laboratory'
        db.delete_table('labs_laboratory')
